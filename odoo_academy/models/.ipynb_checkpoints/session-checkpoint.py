...
class Session(models.Model):
    ...
    name = fields.Char(string="Title", related="course_id.name") # Esto buscara la identificación del curso y luego obtendra el nombre del curso si hay uno disponible.
    ...
    end_date = fields.Date(string="End Date",
                          compute="_compute_end_date",#Calcula la fecha de finalización, utilizando el "start_date".
